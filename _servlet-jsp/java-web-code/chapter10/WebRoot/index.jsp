...
<div id="container">
  ...
  <div id="body" class="clear">
    ...
    <div id="body_left">
      <!-- ============= 好书推荐（开始） ============= -->
      <h2><img src="imgs/bullet1.gif" />上传图书封面</h2>
      <div class="prod clear">
<form action="FileUpload" name = "one" enctype="multipart/form-data" method="post">
  	<p align="center">选择一张图片<input type="file" name="fileupload" value="upload"/><br>
