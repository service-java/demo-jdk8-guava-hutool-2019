...
<div id="container">
  ...
  <div id="body" class="clear">
    ...
    <div id="body_left">
      <!-- ============= 好书推荐（开始） ============= -->
      <h2><img src="imgs/bullet1.gif" />店铺信息</h2>
...
try {
		...
		String s=request.getRealPath("/")+"/book.xml";
		Document document = builder.parse(new File(s));
		Element root = document.getDocumentElement();
		String rootName = root.getNodeName();				
		out.println("<li>店铺类型：" + rootName + "</li>");
		NodeList nodelist = document.getElementsByTagName("儿童读物");
		out.println("<li>主要出售：" +nodelist.item(0).getNodeName()+"</li>");
	} catch (Exception e) {
		out.println(e);
	}
%>
