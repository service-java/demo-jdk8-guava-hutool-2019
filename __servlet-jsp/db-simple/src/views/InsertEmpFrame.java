...
public class InsertEmpFrame extends JFrame {
    ...
    protected void do_closeButton_actionPerformed(ActionEvent arg0) {
        int n = JOptionPane.showConfirmDialog(getContentPane(), "确认正确吗？", "确认对话?", JOptionPane.YES_NO_CANCEL_OPTION);
    ...
    protected void do_insertButton_actionPerformed(ActionEvent arg0) {
        ...
        if (!(nameTextField.getText().equals("")) && (!deptTextField.getText().equals("")) && (!phoneTextField.getText().equals(""))) {
            util.insertEmp(emp);

            JOptionPane.showMessageDialog(getContentPane(), "数据添加成功?", "信息提示?", JOptionPane.WARNING_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(getContentPane(), "请将信息添加完整?", "信息提示?", JOptionPane.WARNING_MESSAGE);
        }
