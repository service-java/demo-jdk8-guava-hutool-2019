...
//        setting = new Setting("config/example.setting");
//
...
//        setting = new Setting(FileUtil.touch("example.setting"), CharsetUtil.UTF_8, true);
//
//        //读取与SettingDemo.class文件同包下的XXX.setting
//        setting = new Setting("XXX.setting", ReadSettingDemo.class, CharsetUtil.UTF_8, true);
//
//        //--------------------------------------------- 使用
//        //获取key为name的值
